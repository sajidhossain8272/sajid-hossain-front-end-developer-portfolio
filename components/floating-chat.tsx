      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              Hi! 👋 I'm available for quick questions or project discussions. Choose your preferred platform:
            </motion.p>
            ...
            <div className="space-y-3">
              ...
              >
                <Button
                  ...
                  onClick={() => {
                    window.open('https://linkedin.com/in/brokephilanthropist', '_blank')
                    setIsOpen(false)
                  }}
                >
                  💼 LinkedIn
