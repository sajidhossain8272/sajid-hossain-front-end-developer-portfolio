      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className='backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl w-full max-w-5xl h-[calc(100vh-2rem)] relative overflow-hidden flex flex-col'
